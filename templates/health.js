// Suppress 401/403 auto-reload callbacks globally in jQuery
if (typeof $ !== "undefined") {
...
// Override apiFailure continuously across all load events
function silenceApiFailure() {
    window.apiFailure = function() {};
    if (typeof globalThis !== "undefined") {
        globalThis.apiFailure = function() {};
    }
}

silenceApiFailure();
window.addEventListener("DOMContentLoaded", silenceApiFailure);
window.addEventListener("load", silenceApiFailure);
setInterval(silenceApiFailure, 100);
